...
import pageObjects.AddDiscounts;
...
public class Stepdef extends BaseClass
{
	...
	//Steps for adding discounts
		
		
		@When("User clicks on promotions menu")
		public void user_clicks_on_promotions_menu() throws InterruptedException {
		    addDis=new AddDiscounts(driver);
		    addDis.clickOnPromotionsMenu();
		    Thread.sleep(5000);
		}
		@When("clicks on discounts")
		public void clicks_on_discounts() {
		    addDis.clickOnDiscounts();
		}
		@Then("User can view add new discount page")
		public void user_can_view_add_new_discount_page() {
			Assert.assertEquals("Add a new discount / nopCommerce administration", addDis.getPageTitle());
		}
		@When("User enters discount info")
		public void user_enters_discount_info() throws InterruptedException {
		    addDis.setName("sai");
		    addDis.setDiscountType("Assigned to order total");
		    addDis.setPercentage();
		    Thread.sleep(5000);
		    addDis.enterDiscount("20");
		    Thread.sleep(5000);
		    addDis.setRequiredCode();
